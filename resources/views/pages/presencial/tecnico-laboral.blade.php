    ...
    <div class="container-fluid page-header" style="margin-bottom: 90px; background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url({{ env('APP_URL') }}img/page-header-02.jpg), no-repeat center center;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Tecnicos Laborales</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 "><a class="text-white" href="">Programas Presenciales</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 "><a class="text-white" href="">Tecnicos Laborales</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    ...
                    <div class="row pb-3">
                        <div class="col-lg-4 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/TLA.jfif" alt="">
                                <a class="blog-overlay text-decoration-none" href="{{ route('pages.presencial.tecnico.auxadmin') }}">
                                    <h5 class="text-white mb-3">Tecnico Laboral en Auxiliar Administrativo</h5>
                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/TAP.jfif" alt="">
                                <a class="blog-overlay text-decoration-none" href="{{ route('pages.presencial.tecnico.auxinfancia') }}">
                                    <h5 class="text-white mb-3">Tecnico Laboral en Auxiliar de Primera Infancia</h5>
                                    <p class="text-white m-0"><span class="badge bg-n-verde-01 p-2">Mas información!</span></p>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/TSE.jfif" alt="">
                                <a class="blog-overlay text-decoration-none" href="{{ route('pages.presencial.tecnico.seguridad') }}">
                                    <h5 class="text-white mb-3">Tecnico Laboral en Seguridad En El Trabajo</h5>
                                    <p class="text-white m-0"><span class="badge bg-n-verde-01 p-2">Mas información!</span></p>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/TMD.jfif" alt="">
                                <a class="blog-overlay text-decoration-none" href="{{ route('pages.presencial.tecnico.mecanica') }}">
                                    <h5 class="text-white mb-3">Tecnico Laboral en Mecanica Diesel Automotriz</h5>
                                    <p class="text-white m-0"><span class="badge bg-n-verde-01 p-2">Mas información!</span></p>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/TOP.jfif" alt="">
                                <a class="blog-overlay text-decoration-none" href="{{ route('pages.presencial.tecnico.operador') }}">
                                    <h5 class="text-white mb-3">Tecnico Laboral en Operador de Maquinaria Pesada</h5>
                                    <p class="text-white m-0"><span class="badge bg-n-verde-01 p-2">Mas información!</span></p>
                                </a>
                            </div>
                        </div>

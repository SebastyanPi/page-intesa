...
@section('content')
    ...
    <!-- Header Start -->
    <div class="mb-5">
        <img class="w-100" src="{{ env('APP_URL') }}img/f_e.png" alt="">
    </div>
    <!-- Header End -->
      ...
      <div class="container-fluid ">
        <div class="container py-2">
            <h4 class="mb-5">Lista de Empresas donde trabajan nuestros egresados!</h4>
            <div class="row">
                <div class="col-lg-12">
                    <div class="row pb-3">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/egresados/1.jpg" alt="">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/egresados/2.jpg" alt="">
                                <a class="blog-overlay text-decoration-none" href="">
                                    <h5 class="text-white mb-3"></h5>
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="blog-item position-relative overflow-hidden rounded mb-2">
                                <img class="img-fluid" src="{{ env('APP_URL') }}img/egresados/3.jpg" alt="">
                                <a class="blog-overlay text-decoration-none" href="">
                                    <h5 class="text-white mb-3"></h5>
                                </a>
                            </div>

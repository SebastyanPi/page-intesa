            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-lg-0 py-3 px-0" >
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a class="btn btn-n-primary py-2 px-2 ml-auto d-none d-lg-block bg-n-verde-01 text-white " href="https://wa.me/573104962668"><i class="fab fa-lg  fa-whatsapp"></i> WhatsApp</a>
                    </div>
                </nav>
